...
/**
 * GET /api/integrations/hubspot/sample-data
 *
 * Returns one example data record for populating the HubSpot field mapping preview.
...
export async function GET() {
  try {
    ...
    console.error('[HubSpot Sample Data] Error:', err)
    return NextResponse.json({ sample: getDefaultSampleData() })
  }
}
